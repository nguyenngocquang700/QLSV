...
<div class="page-heading">
	<div class="page-title">
		<div class="row">
			...
			<c:if test="${message.equals('Thêm mới Phòng Ban thành công !')}">
			...
			<c:if test="${message.equals('Thêm mới Phòng Ban thất bại !')}">
	...
	<form:form action="admin/newdepartment" modelAttribute="department"
		method="POST">
				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-md-6">
							...
							<h6>Mã Nhân Viên Quản Lý</h6>
							<form:select path="maNVQL" class="form-select" id="staff_modal">
